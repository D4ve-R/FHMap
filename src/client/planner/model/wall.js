...
export class Wall {
  ...
  /** Wall thickness. */
  thickness = Config.getNumericValue(configWallThickness);

  /** Wall height. */
  height = Config.getNumericValue(configWallHeight);

  /** Actions to be applied after movement. */
  moved_callbacks = new Callbacks();

  /** Actions to be applied on removal. */
  deleted_callbacks = new Callbacks();

  /** Actions to be applied explicitly. */
  action_callbacks = new Callbacks();
